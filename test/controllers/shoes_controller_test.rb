...
class ShoesControllerTest < ActionController::TestCase
  ...
  test "should create shoe" do
    assert_difference('Shoe.count') do
      post :create, shoe: { color: @shoe.color, comfort: @shoe.comfort, image: @shoe.image, last_use: @shoe.last_use, type: @shoe.type }
    end
  ...
  test "should update shoe" do
    patch :update, id: @shoe, shoe: { color: @shoe.color, comfort: @shoe.comfort, image: @shoe.image, last_use: @shoe.last_use, type: @shoe.type }
    assert_redirected_to shoe_path(assigns(:shoe))
  end
